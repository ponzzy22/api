    ...
    <div class="row justify-content-center">
        <div class="col-md-10 my-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url('informasi', $informasi->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            ...
                            @enderror"
                                name="judul_informasi" value="{{ $informasi->judul_informasi }}">
                        ...
                        <div class="mb-3">
                            ...
                            @enderror"
                                name="category_informasi" value="{{ $informasi->category_informasi }}">
                        ...
                        <div class="mb-3">
                            ...
                            @enderror">{{ $informasi->isi_informasi }}</textarea>
                            @error('isi_informasi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
